...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="table-responsive col-lg-8">
    <a href="/dashboard/posts/create" class="btn btn-light mb-3 text-dark" >New post <span data-feather="file-plus"></a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/dashboard/posts/{{$post->slug}}/edit" class="badge bg-info" > 
